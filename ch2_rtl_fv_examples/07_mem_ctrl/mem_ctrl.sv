...
// The timing parameters DEFAULT to the mem_ctrl_pkg constants, so with no
// override this is the package-configured design; the testbench and the
// formal runs override them with small values (the contracts are
// bound-parametric -- see the Makefile's data-type-abstraction note).
module mem_ctrl #(
